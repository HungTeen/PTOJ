...
import love.pangteen.problem.service.SubmitService;
...
public class SubmitController {
    ...
    @Validated
    public CommonResult<IPage<JudgeVO>> getSubmissionList(@Range(min = 1) @RequestParam(value = "limit", defaultValue = "1") Integer limit,
        ...
        return CommonResult.success(judgeService.getSubmissionList(limit, currentPage, onlyMine, searchPid, searchStatus, searchUsername, completeProblemID, gid));
    }
